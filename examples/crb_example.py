...
def build_parser():
    ...
    p.add_argument("--sim_method", type=str, default="rk4", 
    ...
    p.add_argument("--scheme", default="CN", choices=["CN", "IMR", "RK4"], help="scheme used in the trajectory loss")
    ...
    p.add_argument("--eval_steps", type=int, default=128, help="Rollout length for --plot_trajectory")
